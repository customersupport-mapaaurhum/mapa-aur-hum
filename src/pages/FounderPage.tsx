...
export default function FounderPage() {
  return (
    <>
      <Helmet>
        <title>Founder Sumita Sarkar | MaPa-Aur-Hum Childcare Solution</title>
        <meta name="description" content="Meet Sumita Sarkar, founder of MaPa-Aur-Hum. An experienced mother and IT professional solving childcare challenges for Indian working parents." />
        <meta name="keywords" content="Sumita Sarkar, MaPa-Aur-Hum founder, childcare entrepreneur, working mother India, IT professional" />
      </Helmet>
