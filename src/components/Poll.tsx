          ...
          <Card className="p-8 border-2 border-primary/20 shadow-elegant">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-muted-foreground">
                Would you like MaPa-Aur-Hum to provide coaching videos in the app for day-to-day baby care?
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              >
                <div className="flex items-center gap-3 w-full">
                  ...
                  <span className="flex-1 text-left">Yes, I would love coaching videos!</span>
                </div>
              </Button>
              ...
              >
                <div className="flex items-center gap-3 w-full">
                  ...
                  <span className="flex-1 text-left">No, I don't need coaching videos</span>
                </div>
              </Button>
              ...
              >
                <div className="flex items-center gap-3 w-full">
                  ...
                  <span className="flex-1 text-left">Maybe, depends on the content</span>
                </div>
              </Button>
            </div>
