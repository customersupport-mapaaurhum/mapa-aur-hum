...
const FeedbackDialog = lazy(() =>
  import("@/components/FeedbackDialog").then((m) => ({
      ...
      <div className="container mx-auto px-4">
        <div className="text-center">
          ...
          <p className="text-sm md:text-base text-muted-foreground mb-6 max-w-2xl mx-auto">
            We also provide training on how to use the app for your caregivers.
            Reach out to us if your maid/babysitter/relative needs support.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-2 text-sm md:text-base text-muted-foreground mb-6">
            ...
            <a
              href="mailto:customer.support@mapaaurhum.com"
