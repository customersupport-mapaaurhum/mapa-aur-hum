...
export const Hero = memo(() => {
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-24 lg:pt-28 bg-gradient-to-br from-primary/5 via-background to-secondary/5">
